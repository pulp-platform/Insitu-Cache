...
module cachepool_cache_ctrl #(
    ...
    ***********************/
    ...
    refill_req_t                                                            cache_noninfo_req;
    logic                                                                   cache_noninfo_resp_valid;
    logic                                                                   cache_noninfo_resp_ready;
    refill_rsp_t                                                            cache_noninfo_resp;
    ...
    always_comb begin
        ...
        cache_noninfo_req.info  = info_fifo_in;

        cache_resp_data  = cache_noninfo_resp.data;
        cache_resp_info  = cache_noninfo_resp.info;
        cache_resp_write = cache_noninfo_resp.write;
    end

    assign refill_req_o = cache_noninfo_req;
    assign refill_req_valid_o = cache_noninfo_req_valid;
    assign cache_noninfo_req_ready = refill_req_ready_i;
    assign cache_noninfo_resp = refill_rsp_i;
    assign refill_rsp_ready_o = cache_noninfo_resp_ready;
    assign cache_noninfo_resp_valid = refill_rsp_valid_i;
